<p align="center">
  <img src="public/logo.svg" alt="ProntoPA" width="80" height="80" />
</p>
...
- **Gestione segnalazioni** con workflow a 12 stati e azioni configurabili
...
- **Notifiche Telegram** opzionali con bot integrato
- **API REST + webhook** per integrazione con portali cittadini esterni (Laravel Sanctum)
- **Home pubblica** con statistiche aggregate anonime (trasparenza + GDPR)
...
2. Configura il gruppo **Brand**: nome ente, logo, colori primario e secondario
3. Configura il gruppo **Mappa**: coordinate e zoom del territorio
4. Configura il gruppo **Email**: mittente notifiche

### Telegram

La piattaforma include un bot Telegram opzionale per notifiche push e comandi rapidi operativi.
...
2. Esponi l'istanza su HTTPS pubblico.
...
- `/apri <id>` — mostra il dettaglio con bottoni inline per le azioni rapide
...
# Le migrations vengono eseguite automaticamente all'avvio del container
```
...
├── docker/
│   ├── nginx/               # Config Nginx
│   └── php/                 # php.ini, opcache.ini, entrypoint.sh
├── legacy/                  # Codice originale + script reimport dati
├── resources/views/         # Blade templates
├── public/                  # Asset pubblici (logo.svg, ecc.)
