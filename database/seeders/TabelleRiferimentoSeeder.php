...
class TabelleRiferimentoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('db_azioni')->insertOrIgnore([
            ...
            ['id_azione' => 3,  'descrizione' => 'CHIUDI',                     'id_stato_segnalazione' => 3,  'competenza_azione' => 0, 'colore' => 'danger',    'flag_appalto' => 0, 'flag_operatore' => 0, 'flag_notifica' => 0, 'ordine' => 0, 'parametri_filtro' => '{"stato_1":1,"stato_2":1,"stato_7":1,"stato_8":1,"stato_10":1,"stato_12":1,"stato_14":1,"tipologia_1":1,"tipologia_2":1,"tipologia_3":1,"profilo_1":1}'],
